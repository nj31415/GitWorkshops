...
print("Hello world, my name is Harrison and my favorite programming language is FORTRAN ");
print("Hello world, my name is NICHOLAS and my favorite programming language is SPANISH ");
